...
import { StyleSheet, I18nManager, Platform, Keyboard, StatusBar, View, InteractionManager } from 'react-native';
...
export default class DrawerView extends React.Component {
  constructor(...args) {
    ...
    })), onChange(this.gestureState, cond(eq(this.gestureState, State.ACTIVE), call([], this.handleStartInteraction))), cond(eq(this.gestureState, State.ACTIVE), [cond(this.isSwiping, NOOP, [// We weren't dragging before, set it to true
  ...
  render() {
    ...
    const drawerTranslateX = drawerType === 'back' ? I18nManager.isRTL ? multiply(sub(this.containerWidth, this.drawerWidth), isRight ? 1 : -1) : 0 : this.translateX;
    ...
    drawerType === 'permanent' ? null : /*#__PURE__*/React.createElement(TapGestureHandler, {
